...
try:
    ...
    from sglang.srt.entrypoints.engine import _init_tokenizer_manager as init_tokenizer_manager
...
class SGLangHttpServer:
    ...
    async def launch_server(self, master_address: str = None, master_port: int = None):
        ...
        # A800 container: disable IB/P2P to prevent Gloo/NCCL deadlock in subprocesses
        ...
        try:
            ...
            # sglang 0.5.2: _launch_subprocesses only accepts server_args and returns 3 values
            result = _launch_subprocesses(server_args=server_args)
            if len(result) == 3:
                self.tokenizer_manager, self.template_manager, self.scheduler_info = result
            else:
                self.tokenizer_manager, self.template_manager, self.scheduler_info, _ = result
        ...
        app.warmup_thread_kwargs = dict(
            ...
            execute_warmup_func=lambda _: True,
        )
